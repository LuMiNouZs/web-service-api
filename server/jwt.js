...
var i 	= '1-to-all Ltd';    	// Issuer (Software organization who issues the token)
var s 	= 'anupol@1-to-all.com';	// Subject (intended user of the token)
var a 	= 'http://1-to-all.com';	// Audience (Domain within which this token will live and function)
